    ...
    <div class="nav-sidebar" :class="{ collapsed: isCollapsed }">
      <div class="sidebar-header">
        <div class="logo-area">
          ...
          <span class="logo-text" v-if="!isCollapsed">运维控制台</span>
        </div>
...
// 主题相关
const isDarkTheme = computed(() => document.body.classList.contains('dark-for-flat'))
...
const toggleCollapse = () => {
  ...
  localStorage.setItem('nav_collapsed_flat', isCollapsed.value ? 'true' : 'false')
}

// 切换主题
const toggleTheme = () => {
  document.body.classList.toggle('dark-for-flat')
  const isDark = document.body.classList.contains('dark-for-flat')
...
const initData = () => {
  ...
  if (savedTheme === 'dark') document.body.classList.add('dark-for-flat')
...
body.dark-for-flat .nav-sidebar,
body.dark-for-flat .top-action-bar,
body.dark-for-flat .custom-tabs,
body.dark-for-flat .stat-card,
body.dark-for-flat .glass-panel {
  background: #1E293B;
  border-color: #334155;
}

body.dark-for-flat .el-menu-item,
body.dark-for-flat .el-sub-menu__title {
  color: #CBD5E1 !important;
}

body.dark-for-flat .el-menu-item.is-active {
  background: #2D3A4E !important;
  color: #60A5FA !important;
}

body.dark-for-flat .collapse-btn {
  background: #334155;
  color: #E2E8F0;
}

body.dark-for-flat .right-workspace {
  background: #0F172A;
}
...
body.dark-for-flat .custom-tabs .el-tabs__item {
  color: #94A3B8;
}

body.dark-for-flat .custom-tabs .el-tabs__item.is-active {
  color: #60A5FA;
}

body.dark-for-flat .custom-tabs .el-tabs__item:hover {
  background: #2D3A4E;
}

body.dark-for-flat .btn-icon-group .el-button {
  color: #94A3B8;
}

body.dark-for-flat .btn-icon-group .el-button:hover {
  color: #60A5FA;
  background: #334155;
}
</style>